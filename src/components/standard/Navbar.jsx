        ...
        <div className=' w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
            <div className=' px-2 flex justify-between items-center w-full h-full'>
                <div className=' flex items-center'>
                    ...
                    <h1 className=' text-3xl font-bold mr-4 teal sm:text-4xl'>Macro<span className='info'>Infos</span> </h1>
                ...
                <div className=' hidden md:flex pr-4'>
                    <button className=' border-none bg-transparent  text-black mr-4'>Connexion</button>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
                ...
                <div className='flex flex-col my-4'>
                    <button className=' bg-transparent info px-8 py-3 mb-4'>Connexion</button>
                    <button className=' px-8 py-3 bg-teal'>Inscription</button>
                </div>
            </ul>
